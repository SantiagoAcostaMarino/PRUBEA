...
def ejecutar_avistamientos_en_fecha(avistamientos:dict) -> None:
    ...
    respuesta = ov.avistamientos_en_fecha(avistamientos, fecha)
    print ("se cargaron los siguientes avistamientos que fueron registrados en la fecha ingresada por parámetro: ")
    print (respuesta)
...
def ejecutar_avistamientos_por_ciudad(avistamientos:dict) -> None:
    ...
    """
    respuesta = ov.avistamientos_por_ciudad(avistamientos)
    print ("los avistamientos registrados por ciudad de ocurrencia son:")
    print(respuesta)
...
def ejecutar_avistamientos_mas_de_x_segundos(avistamientos:dict) -> None:
    ...
    respuesta = ov.avistamientos_mas_de_x_segundos(avistamientos, limite)
    print ("los avistamientos que tuvieron una duración mayor a un número de segundos ingresado por parámetro son: ")
    print (respuesta)
...
def ejecutar_avistamientos_por_rango_de_fechas(avistamientos:dict) -> None:
    ...
    respuesta = ov.avistamientos_por_rango_de_fechas(avistamientos, fecha_in, fecha_fin)
    print ("Los siguientes son todos los avistamientos que fueron registrados dentro del rango de fechas ingresado por parámetro: ")
    print (respuesta)
...
def ejecutar_avistamientos_en_radio_determinado(avistamientos:dict) -> None:
    ...
    respuesta = ov.avistamientos_en_radio_determinado(avistamientos, lat, long, radio)
    print ("los avistamientos que se encuentran dentro del radio que tiene como centro la longitud y la latitud ingresada por parámetro son los siguientes:")
    print (respuesta)
...
def ejecutar_minimo_x_avistamientos_en_mes(avistamientos:dict) -> None:
    ...
    respuesta = ov.minimo_x_avistamientos_en_mes(avistamientos, cantidad_minima, fecha)
    if respuesta == True:
...
def ejecutar_dar_avistamiento_mas_corto_y_largo_por_pais(avistamientos:dict) -> None:
    ...
    respuesta = ov.dar_avistamiento_mas_corto_y_largo_por_pais(avistamientos, pais)
    print ("El avistamiento mas corto y el avistamiento mas largo registrados en el pais ingresado por parametros son:")
    print(respuesta)
...
def ejecutar_contar_avistamientos_por_forma(avistamientos:dict) -> None:
    ...
    """
    respuesta = ov.contar_avistamiento_por_forma(avistamientos)
    print ("el número de avistamientos según la forma del OVNI: ")
    print (respuesta)
...
def ejecutar_pais_con_mas_avistamientos_de_x_segundos(avistamientos:dict) -> None:
    ...
    """
    limite = float(input("Ingrese el límite inferior de la duración de un avistamiento en segundos: "))
    respuesta = ov.pais_con_mas_avistamientos_de_x_segundos(avistamientos, limite)
    print ("El país con más avistamientos que duran al menos ", limite, " segundos es ", respuesta["pais"], " con " , respuesta["avistamientos"], " avistamientos.")
...
def ejecutar_avistamientos_que_contengan_cadena_en_comentarios(avistamientos:dict) -> None:
    ...
    respuesta = ov.avistamientos_que_contengan_cadena_en_comentarios(avistamientos, cadena)
    print("los avistamientos que contienen la cadena ingresada dentro de los comentarios del avistamiento registrado son los siguientes:")
    print(respuesta)
